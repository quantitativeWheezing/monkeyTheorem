 ...
 *                       number of threads per block, SHMEM_SIZE
 *                       Also, SHMEM_SIZE must be in {16,32,64,128,256,512}
 ...
 *               Must be divisible by: SHMEM_SIZE, 
 *               (SHMEM_SIZE*MATCH_VEC_SIZE), and TARGET_LENGTH
...
constexpr unsigned int SHMEM_SIZE = BLOCK_SIZE_X*BLOCK_SIZE_Y;
